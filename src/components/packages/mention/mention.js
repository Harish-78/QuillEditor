...
function setInnerContent(element, value) {
  ...
  if (_typeof(value) === "object") element.appendChild(value);
    ...
    function (prev, mentionChar) {
      ...
      if (isolateChar && allowInlineMentionChar) {
        var regex = new RegExp(
          "^".concat(mentionChar, "|\\s").concat(mentionChar),
          "g"
        );
...
export var MentionBlot = /*#__PURE__*/ (function (_Embed) {
    ...
    [
      {
        ...
        value: function create(data) {
          var node = _get(_getPrototypeOf(MentionBlot), "create", this).call(
            this
          );
  ...
  _createClass(Mention, [
      ...
      value: function insertItem(data, programmaticInsert) {
        ...
        if (!programmaticInsert) {
          ...
          this.quill.deleteText(
            ...
            Quill__default["default"].sources.USER
          );
        } else {
    ...
    },
    {
      ...
      value: function setMentionContainerPosition_Fixed() {
        ...
        var relativeToPos = this.options.fixMentionsToQuill
          ? containerPos
    ...
    },
    {
      ...
      value: function onSomethingChange() {
        ...
        var textPrefix = textOffset
          ? this.quill.getText(textOffset - 1, textOffset)
          : "";
        var _getMentionCharIndex = getMentionCharIndex(
            textBeforeCursor,
